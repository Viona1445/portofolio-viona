                    ...
                    <div className="flex-1">
                        ...
                        <div className="space-y-4">
                            {cvData.certificates.map((cert, idx) => (
                                ...
                                >
                                    <div className="w-12 h-12 rounded-xl bg-premium-pink/20 flex items-center justify-center text-premium-pink shrink-0">
                                        {getIcon(cert.icon)}
                                    </div>
                                    <div>
                        ...
                        <div className="grid gap-6">
                            {cvData.achievements.map((ach, idx) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-2xl font-bold text-premium-pink mb-2">{ach.title[currentLang]}</h3>
